...
const nativeLib = join(packageRoot, 'node_modules', 'meta-messenger.js', 'build', `messagix.${ext}`);
...
console.log('[ensure-native] Downloading prebuilt binary from GitHub Releases...');

const downloadScript = join(packageRoot, 'node_modules', 'meta-messenger.js', 'scripts', 'download-prebuilt.mjs');
